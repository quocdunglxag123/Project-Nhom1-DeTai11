...
//                                echo $json_item_key;
                                ...
                                <tr>
                                    ...
                                    <td><?php show_array($item); ?></td>
                                    <td>
                                        <a href='?mod=items&act=update&table_name=<?php echo $table_name; ?>&key=<?php echo $json_item_key;?>'>Sửa</a>|<a href='?mod=items&act=delete&table_name=<?php echo $table_name; ?>&key=<?php echo $json_item_key;?>'>Xóa</a>
                                    </td>
                                </tr>
                                <?php
                            }
